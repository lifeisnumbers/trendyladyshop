...
The plugin relies on a 3rd party as a service (www.crazyegg.com) in order to track visitor clicks and mouse movements. Please visit www.crazyegg.com/terms and www.crazyegg.com/privacy to find out more about our policies.
...
If you've signed up for Snapshots and Recordings, you'll only need to install this plugin once.
...
= 2.5 =
* Tested with latest Wordpress version 5.7

= 2.4 =
* Updated tested up to

= 2.3 =
* Tested with latest Wordpress version 5.5
...
* Plugin uses full tracking script instead of Account Number.
